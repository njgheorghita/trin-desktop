            ...
            <Card>
              ...
              <CardContent>
                <Form :form="hashForm" @submit="hashForm.handleSubmit(fetchBlockByHash)">
                  <FormField name="blockHash" v-slot="{ field }" :control="hashForm.control">
                    <FormItem>
                  ...
                  <Button type="submit" :disabled="isLoadingHash" class="mt-4">
            ...
            <Card>
              ...
              <CardContent>
                <Form :form="numberForm" @submit.prevent>
                  <FormField name="blockNumber" v-slot="{ field }" :control="numberForm.control">
                    <FormItem>
                  ...
                  <Button type="submit" :disabled="isLoadingNumber" class="mt-4">
